...
//    echo "ID :" .$receiver_ID . "&&& roomID :".$receiver_name ;
// echo "receiver :". $receiver_ID." %%%% room: ".    $room_ID  ;

$sender_id=$_SESSION['shop_onwer_id']; 
...
<h2 class="text-center p-2 m-0 "style="background-color: #192a51; color:white; 
    font-size:25px;"> <a href="rooms.php" style="color:white"><span style="float: left;"><i class="fa-solid fa-arrow-left"style="
    color: white;
    font-size: 25px;
"></i></span> </a> 
      Chat Room</h2>
...
<script>
    ...
    function loadChatMessages() {
        ...
        $.ajax({
            ...
            type: 'GET',
            data: { receiverID: '<?php echo  $receiver_ID ; ?>', roomID: '<?php echo $room_ID ; ?>' },

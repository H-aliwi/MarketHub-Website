...
if (isset($_SESSION['shop_onwer_id']) ) 
{
 ...
 include("intil.php");  //<!-- router -->
  ...
  $stat = $con->prepare("SELECT * FROM item WHERE shopID='$shopID' ORDER BY List_date ASC ");
  $stat->execute();
?>
...
?>
        ...
        <table id="Table" class="display" style="width:100%">
            ...
            <thead>
                <tr><th colspan="14"><div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="Add_item.php" class="btn btn-light btn-sm p-2"><i class="fa-sharp fa-solid fa-plus"></i>Add New item</a>
                </div></th></tr>
                <tr>
                    <th>Item ID</th>
                    <!-- <th>Category ID</th>
    ...
    if ($stat->rowCount() > 0) {
      while ($row = $stat->fetch()) {
        ...
        <td><img src="layout/images/items/'.$row['Item_image'].'" alt="Description of the image" style="width: 55px;" "></td>
        <td   style="display: inline-flex;">    
                 <button type="submit" class="btn-danger deletebtn" 
                    style=" margin-right: 7px;padding: 5px;display: flex;border-radius: 10%;justify-content: center;align-items: center;">
                    <i class="fa-solid fa-trash-can"></i>
                </button>  
                <a href="edit_Item.php?itemID='.$row['ItemID'].'"> 

...
<?php
session_start();
 include('includes/functions/getCustomerUsername.php'); 
 include('includes/functions/getshopOwnerUsernameByUserId.php'); 
 include('includes/functions/ISshopOwner.php'); 
...
$sender_name =$_SESSION['usernameA'];


// echo "sender is :".$sender_name ." and receiver_name :".$receiver_name;
